...
static void GetIumData(void)
{
    ...
    robot.imu_datas.gyro_vals[ROLL] = gyro_data[ROLL]*0.9+robot.imu_datas.gyro_vals[ROLL]*0.1;
    robot.imu_datas.gyro_vals[PITCH] = gyro_data[PITCH]*0.9+robot.imu_datas.gyro_vals[PITCH]*0.1;
    robot.imu_datas.gyro_vals[YAW] = gyro_data[YAW]*0.9+robot.imu_datas.gyro_vals[YAW]*0.1;
...
static void UpdataLegState(void)
{
    ...
    for (uint8_t i = 0; i < 2; i++)
    {
        ...
        robot.leg_states[i].curr.state.dheight * sin(robot.leg_states[i].curr.state.theta) 
        - robot.leg_states[i].curr.state.height * cos(robot.leg_states[i].curr.state.theta) * robot.leg_states[i].curr.state.dtheta
         - robot.leg_states[i].curr.state.dphi * cos(robot.leg_states[i].curr.state.phi) * kBarycenterHeight;
