 ...
 * @note        None
 */
A1::A1(uint8_t id, const OptionalParams& optinal_params) : Motor()
{
  /* 变量检查 */
#pragma region
 ...
 */
State A1::encode(uint8_t tx_data[8], uint32_t tx_msg_std_id)
{
  /* 变量检查 */
#pragma region
 ...
 */
State A1::decode(const uint8_t rx_data[8], uint32_t rx_msg_std_id)
{
  /* 变量检查 */
#pragma region
