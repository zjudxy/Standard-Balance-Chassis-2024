 ...
 */
DM_J4310::DM_J4310(uint8_t id, const OptionalParams& optinal_params,
...
State DM_J4310::setInput(float input)
{
  float torq_input = 0;
...
State DM_J4310::set_input_type(InputType input_type)
{
 ...
 */
State DM_J4310::encode(uint8_t tx_data[8], uint32_t tx_msg_std_id)
{
  /* 变量检查 */
#pragma region
 ...
 */
State DM_J4310::decode(const uint8_t rx_data[8], uint32_t rx_msg_std_id)
{
  /* 变量检查 */
#pragma region
