...
#ifndef HW_COMPONENTS_TOOLS_LINKED_LIST_HPP_
#define HW_COMPONENTS_TOOLS_LINKED_LIST_HPP_
...
{
  if (index >= _size) return add(_t);

  if (index == 0) return unshift(_t);
